...
<br>
throw − A program throws an exception when a problem shows up. This is done using a throw keyword.<tr><br>

catch − A program catches an exception with an exception handler at the place in a program where you want to handle the problem. The catch keyword indicates the catching of an exception.<br><br>
...
For better understanding refer to Exception Handling.cpp and Communicate_between_try_and_throw_with_function.cpp
<br><br>
